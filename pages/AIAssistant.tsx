...
const TaxBuddyFeature: React.FC<{ title: string; description: string; to: string; icon: string; }> = ({ title, description, to, icon }) => (
            ...
            <header className="sticky top-0 z-10 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-sm border-b border-border-light dark:border-border-dark">
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-center h-16">
                        <h1 className="text-lg font-bold text-text-light dark:text-text-dark">Tax Buddy</h1>
                    </div>
                </div>
            </header>
